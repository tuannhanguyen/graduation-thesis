...
public class ShoppingCartRestController {
	...
	@GetMapping("/cart/getQty")
	public Integer getQtyInCart(HttpServletRequest request) throws CustomerNotFoundException {
	    Customer customer  = getAuthenticatedCustomer(request);
	    return shoppingCartService.countQuantityinCart(customer);
	}
}