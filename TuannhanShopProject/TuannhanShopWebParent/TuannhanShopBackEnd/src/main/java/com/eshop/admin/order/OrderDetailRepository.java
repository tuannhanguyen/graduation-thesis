...
public interface OrderDetailRepository extends CrudRepository<OrderDetail, Integer> {
    ...
    @Query("SELECT NEW com.eshop.common.entity.OrderDetail(d.product.category.name, d.quantity,"
    ...
    @Query("SELECT NEW com.eshop.common.entity.OrderDetail(d.quantity, d.product.name,"
            + " d.productCost, d.shippingCost, d.subtotal)"
            + " FROM OrderDetail d WHERE d.order.orderTime BETWEEN ?1 AND ?2")
